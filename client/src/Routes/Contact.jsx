    ...
    return(
        <>
            <div className="w-[100%] flex justify-evenly">
                ...
                <input  className="outline-none md:w-[290px] pl-3 w-[150px] h-[45px] bg-slate-800 border-[1px] border-slate-500 rounded-md" placeholder="Email Address" type="text" />
            </div>
            <textarea onChange={e=>{setTitle(e.target.value)} } className="outline-none pl-3 bg-slate-800 border-[1px] border-slate-500 rounded-md pt-2 w-[320px] md:w-[600px]" placeholder="Your Message"  name="" id="" cols="80" rows="5"></textarea>
            <div className="w-[100%] flex justify-end md:pt-2">
